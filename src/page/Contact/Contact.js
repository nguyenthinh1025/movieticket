...
const Contact = () => {
    return (
        <div>
            ...
            <section className=" z-10 overflow-hidden bg-white py-20 ">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">
                                            District 2 , Ho Chi Minh , Viet Nam
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">(+84) 414 257 980</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">abcd@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
